...
import { AVAILABILITY_DAYS, AVAILABILITY_TIME, ONBOARDING_TRAINER } from '@app/modules/onboarding/constants/onboarding';
...
import { selectOnboardingClient, selectOnboardingTrainer } from '@app/modules/onboarding/store/onboarding.selectors';
