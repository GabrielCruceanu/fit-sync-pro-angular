...
import { TRAINER_EXPERIENCE, TRAINER_TYPES } from '@app/modules/onboarding/constants/trainer';
import { TrainerType } from '@app/modules/onboarding/models/trainer.model';
