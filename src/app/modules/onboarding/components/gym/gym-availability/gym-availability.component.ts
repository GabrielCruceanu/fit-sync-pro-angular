...
import { OnboardingGymSteps, OnboardingStep } from '@app/modules/onboarding/models/onboarding.model';
import { AVAILABILITY_DAYS, AVAILABILITY_TIME, ONBOARDING_GYM } from '@app/modules/onboarding/constants/onboarding';
